...
const AddCourse = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Submit course data:", {
      courseTitle,
      coursePrice,
      discount,
      image,
    ...
    <div className="h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0">
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          ...
          <div
            ref={editorRef}
            className="bg-white h-40 border border-gray-300 rounded p-2"
          />
        </div>
        ...
        {showPopup && (
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40">
            <div className="bg-white p-4 rounded w-full max-w-md relative text-gray-900">
