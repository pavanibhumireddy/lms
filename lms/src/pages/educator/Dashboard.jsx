...
import Loading from "../../components/students/Loading"; // Make sure path is correct
...
const Dashboard = () => {
  ...
  return dashboardData ? (
    <div className="min-h-screen flex flex-col items-start justify-between gap-3 md:p-8 md:pb-0 p-4 pt-8 pb-0">
